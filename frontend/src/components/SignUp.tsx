...
const SignUp: React.FC<SignUpProps> = ({ onSignUp, onSwitchToSignIn, signUpError }) => {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex-1 p-4 flex flex-col">
        ...
        {(error || signUpError) && <p className="text-red-500 text-sm text-center mt-2">{error || signUpError}</p>}
